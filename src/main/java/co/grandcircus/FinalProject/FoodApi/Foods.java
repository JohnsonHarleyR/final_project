package co.grandcircus.FinalProject.FoodApi;
...
public class Foods {
	...
	public String toString() {
		return "Foods [food_name=" + food_name + ", brand_name=" + brand_name + ", serving_qty=" + serving_qty
				+ ", serving_unit=" + serving_unit + ", serving_weight_grams=" + serving_weight_grams + ", nf_calories="
